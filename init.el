...
;; (setq linux-command-modifier 'meta) ; make cmd key do Meta
;; (setq linux-option-modifier 'super) ; make option key do Super.
;; (setq linux-control-modifier 'control) ; make Control key do Control
...
;; byte-compile with (byte-compile-file "~/.emacs.d/elisp/electric-spacing/electric-spacing.el")
;; byte-compile with (byte-compile-file "~/.emacs.d/elisp/electric-spacing/electric-spacing-r.el")
;; (add-to-list 'load-path "~/schooner-emacs/elisp/electric-spacing")
(use-package electric-spacing
    :ensure t)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ivy-bibtex ef-themes yasnippet wc-mode use-package rainbow-delimiters powerline maxframe material-theme exec-path-from-shell electric-spacing better-defaults au
to-complete auctex atomic-chrome)))
(custom-set-faces
